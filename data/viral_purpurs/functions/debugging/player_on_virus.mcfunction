...
execute at @p positioned ~ ~-.001 ~ if predicate viral_purpurs:is_virus run say ...and predicate says viral?: YES
execute at @p positioned ~ ~-.001 ~ unless predicate viral_purpurs:is_virus run say ...and predicate says viral?: NO
