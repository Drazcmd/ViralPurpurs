...
# NOTE: VERY important to use yval-.001 instead of -1 below. -1 doesn't work if standing on blocks shorter
...
execute at @p positioned ~ ~-.001 ~ if predicate viral_purpers:is_virus run say ...and predicate says viral?: YES
execute at @p positioned ~ ~-.001 ~ unless predicate viral_purpers:is_virus run say ...and predicate says viral?: NO
